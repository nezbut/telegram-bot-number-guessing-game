...
LEXICON_RU: dict[str, str | Callable] = {
    ...
    'help_cmd': lambda keyboard_text: ("/help", keyboard_text),
    'stat_cmd': lambda keyboard_text: ("/stat", keyboard_text),
    'go_cmd': lambda keyboard_text: ("/go", keyboard_text),
    'stop_cmd': lambda keyboard_text: ("/stop", keyboard_text),
    'reset_cmd': lambda keyboard_text: ("/reset", keyboard_text)
}
